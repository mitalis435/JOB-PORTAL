      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            ...
            <p className="text-sm">© 2026 Job Portal. All rights reserved.</p>
          </div>
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            ...
            <Link to="/PrivacyPolicy" className="hover:text-gray-400" aria-label="Privacy Policy">
              Privacy Policy
            </Link>
            <Link to="/TermsofService" className="hover:text-gray-400" aria-label="Terms of Service">
