    ...
    <div className="flex items-center justify-center min-h-[calc(100vh-64px)] bg-gray-50 px-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm mt-2">Join Job Portal today</p>
        </div>
        ...
        <div className="mt-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          ...
          <div className="w-full md:w-auto">
            <Label className="text-gray-700 font-semibold mb-2">Profile Photo</Label>
            <Input
              type="file"
              accept="image/*"
        ...
        <div className="mt-8">
          {loading ? (
            ...
            <button
              ...
              className={`w-full py-3 rounded-lg font-semibold text-md transition-colors ${termsAccepted
